...
const active = ref<'recommend' | 'nearby' | 'online'>('recommend')
const emit = defineEmits<{
  (e: 'change', v: 'recommend' | 'nearby' | 'online'): void
  (e: 'search'): void
}>()
function set(v: 'recommend' | 'nearby' | 'online') {
  active.value = v
  emit('change', v)
}
</script>
...
<template>
  <header class="top">
    <div class="center">
      ...
      <button :class="['tab', active === 'online' && 'active']" @click="set('online')">在线</button>
    </div>
